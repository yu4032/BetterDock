...
public class ConfigSchemaTest {
    ...
    @Test
    public void composeLiquidSpecsKeepCompatibleDefaultsAndExpandedPrismalBounds() {
        assertComposeIntSpec(ConfigSchema.Glass.BLUR, 6, 0, 60);
        assertComposeIntSpec(ConfigSchema.Glass.THICKNESS, 18, 1, 80);
        assertComposeIntSpec(ConfigSchema.Glass.IOR, 155, 100, 220);
        assertComposeIntSpec(ConfigSchema.Glass.NORMAL_STRENGTH, 115, 0, 400);
        assertComposeIntSpec(ConfigSchema.Glass.DOME, 100, 0, 200);
        assertComposeIntSpec(ConfigSchema.Glass.LENS_REFRACTION, 12, 0, 60);
        assertComposeIntSpec(ConfigSchema.Glass.CHROMATIC, 8, 0, 80);
        assertComposeIntSpec(ConfigSchema.Glass.TINT_ALPHA, 38, 0, 255);
        ...
        assertComposeIntSpec(ConfigSchema.Glass.HIGHLIGHT_WIDTH, 100, 20, 500);
        assertComposeIntSpec(ConfigSchema.Glass.HIGHLIGHT_ALPHA, 100, 0, 200);
        assertComposeIntSpec(ConfigSchema.Glass.DEPTH_EFFECT, 8, 0, 200);
        assertComposeIntSpec(ConfigSchema.Glass.BRIGHTNESS, 108, 50, 220);
        assertComposeIntSpec(ConfigSchema.Glass.SPECULAR_SHARPNESS, 88, 1, 240);
        ...
        assertComposeIntSpec(ConfigSchema.Glass.CAUSTICS, 28, 0, 200);
