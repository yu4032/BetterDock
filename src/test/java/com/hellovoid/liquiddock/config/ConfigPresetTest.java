...
public class ConfigPresetTest {
    ...
    public void defaultPresetKeepsTheComposePersistedValues() {
        ...
        expected.put("liquid_chromatic", 8);
        expected.put("liquid_tint_alpha", 64);
        expected.put("liquid_tint_r", 119);
        expected.put("liquid_tint_g", 122);
        expected.put("liquid_tint_b", 122);
        ...
        expected.put("liquid_specular_strength", 105);
        expected.put("liquid_rim_light", 100);
        ...
        expected.put("liquid_blur", 0);
        expected.put("liquid_blur_tenths", 0);
        expected.put("liquid_thickness", 18);
        expected.put("liquid_thickness_tenths", 180);
        expected.put("liquid_lens_refraction", 12);
        expected.put("liquid_lens_refraction_tenths", 120);
        ...
        assertEquals(Integer.valueOf(170), PresetManager.defaultValues().get("liquid_ior"));
