...
public class WorkstationFullscreenProducerRecoveryContractTest {
    ...
    @Test public void workstationLauncherResumeForcesProducerRebindWithoutRebuildingGlass() throws Exception {
        ...
        // This path is producer-only: the HotSeats hierarchy and TextureView remain attached.
    ...
    @Test public void producerRebindNeverReusesAnAlreadyParceledBufferQueueProducer() throws Exception {
        ...
        // HyperOS SetPassBlurSurface calls BBinder.setInheritRt() on the producer. Android 16
        // aborts if that same local binder has already been parceled to SurfaceFlinger once.
        ...
        // Fail closed if either newly created object somehow aliases the already-parceled one.
