...
private val liquidSpecs = listOf(
    ...
    IntSpec("liquid_divider_r", "分割线 · 红", 255, 0, 255, ""),
    IntSpec("liquid_divider_g", "分割线 · 绿", 255, 0, 255, ""),
    IntSpec("liquid_divider_b", "分割线 · 蓝", 255, 0, 255, ""),
    IntSpec("liquid_divider_alpha", "分割线亮度", 100, 0, 200, "%"),
