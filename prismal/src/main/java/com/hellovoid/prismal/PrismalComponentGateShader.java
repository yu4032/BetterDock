...
/** Adds independent runtime gates to Prismal's additive highlight components. */
final class PrismalComponentGateShader {
    ...
    private static final String COMPONENT_UNIFORMS = """
            ...
            uniform float u_componentCompactSafeHighlight;
            """;
    ...
    static String apply(String fragment) {
        ...
        String corrected = insertExactlyOnce(
                fragment,
                DECLARATION_ANCHOR,
                DECLARATION_ANCHOR + "\n" + COMPONENT_UNIFORMS,
    ...
    private static String insertExactlyOnce(
            String source, String anchor, String replacement, String label) {
        return replaceExactlyOnce(source, anchor, replacement, label);
    }
