...
new = '''                    android.view.SurfaceControl[] excludes = null;\n                    if ((requestedSource == CaptureSourcePolicy.Source.FULL_DISPLAY\n                            || (workstationMode\n                                && requestedSource == CaptureSourcePolicy.Source.LOCAL_LAYER))\n                            && dockWindowSurface != null) {\n                        excludes = new android.view.SurfaceControl[]{dockWindowSurface};\n                    }\n                    boolean appHomeLauncherRootExcluded = false;\n                    if (!workstationMode\n                            && requestedSource == CaptureSourcePolicy.Source.FULL_DISPLAY\n                            && requestScene == CaptureScene.APP\n                            && sceneState.appHomeHandoffPending()) {\n                        android.view.SurfaceControl launcherRoot =\n                                AppHomeAnimationLayerExclusion.currentValidSurface();\n                        if (launcherRoot != null) {\n                            excludes = appendCaptureExcludeLayer(excludes, launcherRoot);\n                            appHomeLauncherRootExcluded = true;\n                        }\n                    }\n                    logI("APP HOME capture Launcher-root excluded="\n                            + appHomeLauncherRootExcluded);\n'''

if "appHomeLauncherRootExcluded" not in text:
...
print("APP HOME Launcher-root exclusion patch applied")
